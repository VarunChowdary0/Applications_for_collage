...
const Edit_Info: React.FC = () => {
  ...
  const getBranch = (rollNum:string) => {
    ...
    if(subStr==="66"){
      return "Computer Science and Engineering Artificial Intilligence"
    }
    return "";
      ...
      <div className=" h-fit w-fit shadow-xl overflow-hidden
          ...
          <div
            className=" absolute h-[150px] w-[150px] top-[20%] max-sm:top-[100px]     
             bg-[#4c4b4b] max-sm:scale-75 left-1 max-sm:left-[-10px] rounded-full  overflow-hidden z-40"
          >
            <img
